    ...
    <ScreenContainer>
      <NativeTabs>
        ...
        <NativeTabs.Trigger name="learning">
          <Icon
            selectedColor={"#f0b100"}
            src={<VectorIcon family={LucideIcon} name="learning" />}
          />
          <Label hidden />
        </NativeTabs.Trigger>
        <NativeTabs.Trigger name="plan">
          <Icon
            selectedColor={"#f0b100"}
            src={<VectorIcon family={LucideIcon} name="chart" />}
          />
          <Label hidden />
        </NativeTabs.Trigger>
        <NativeTabs.Trigger name="profile">
          <Icon
            selectedColor={"#f0b100"}
            src={<VectorIcon family={LucideIcon} name="user" />}
          />
          <Label hidden />
        </NativeTabs.Trigger>
      </NativeTabs>
